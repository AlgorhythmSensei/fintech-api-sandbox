  ...
  return (
    <section className="rpa-panel" aria-labelledby="rpa-title">
      <div className="rpa-head">
        <div><p className="eyebrow">Automation</p><h2 id="rpa-title">RPA walkthrough</h2><p>Runs 10 sandbox API scenarios: reset, token, FX rate, list/get accounts, beneficiaries, payment, retrieval, and insufficient balance handling.</p></div>
